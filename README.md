...
- **ターミナル / コマンドプロンプト / PowerShell**：文字を打ってパソコンを操作する画面のことです
- **コマンド**：その画面に打ち込む命令文のことです
- **Claude Code**：ターミナル上で動くAIコーディングツールです
...
お使いのOSに合わせて、以下の**公式推奨**コマンドを実行してください。コマンドはいずれも公式ドメイン `claude.ai` および [Anthropic公式GitHub](https://github.com/anthropics/claude-code) に記載されているものです。
